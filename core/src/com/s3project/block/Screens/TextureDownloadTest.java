...
public class TextureDownloadTest implements HttpResponseListener, ApplicationListener {
			...
			ClickListener clickListener = new ClickListener() {
				...
				public void clicked (InputEvent event, float x, float y) {
					...
					if (clickedButton == btnDownloadImage)
						url = "http://static.ffexforce.jp/webview/1.0.0.0.help.e1478ac4/help/img/intro/01_05.png";
					...
					httpRequest.setContent(requestContent);
                                                                                            Gdx.net.sendHttpRequest(httpRequest, TextureDownloadTest.this);
